        ...
        <table class="table table-bordered table-condensed table-striped">
          ...
          <tbody>
            <?php
                 include"koneksi.php";
                 $no = 1;
                 $query = "SELECT * FROM smk_kelas_xirpl2";
  ...
  <div class="modal fade" id="ModalInput" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <h4 class="modal-title"style="text-align: right" id="myModalLabel">Tambah Data</h4>
...
<script src="assets/js/bootstrap.min.js"></script>  
  ...
  if(isset($_POST['simpan'])){
    ...
    $query = "INSERT INTO smk_kelas_xirpl2(nis, nama, jenis_kelamin, alamat) VALUES('$nis','$nama','$jk','$alamat')";
    $sql = mysqli_query($conn, $query);
